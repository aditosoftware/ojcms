 ...
 * A type implementing this interface must hold an {@link IEncapsulated} data core which acts as an {@link IEventPublisher}.
 *
 ...
 */
interface IObervableBeanValues<BEAN extends IBean<BEAN>, ENCAPSULATED extends IEncapsulated> extends IEncapsulatedHolder<ENCAPSULATED>
{
  /**
