 ...
 */
class ReadOnlyInvocationHandler<SOURCE> implements InvocationHandler
{
   ...
   */
  static <INTERFACE> INTERFACE createReadOnlyInstance(Class<INTERFACE> pInterfaceType, INTERFACE pInstanceToMakeReadOnly)
  {
