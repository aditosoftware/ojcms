 ...
 */
public interface ISingleFieldFlatDataMapper<VALUE> extends IBeanFlatDataMapper
{
  /**
   ...
   */
  Stream<FieldTuple<VALUE>> flatMapForField(IField<VALUE> pField, VALUE pValue);

  @Override
  default Stream<FieldTuple<?>> flatMapTuple(IField<?> pField, Object pValue)
  {
    //noinspection unchecked
    return flatMapForField((IField<VALUE>) pField, (VALUE) pValue)
        .map(pTuple -> pTuple);
  }
}
