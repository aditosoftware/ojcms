...
public class BeanTransformationTest
{
  ...
  //  assertTrue(pBean.getEncapsulatedData().isLinked(pTransformable));
  ...
  // */
  //private static class _Transformator extends AbstractVisualTransformator<LOGIC, VISUAL, IEncapsulatedBeanData, BEAN> implements IVisualBeanTransformator<LOGIC, VISUAL, BEAN>
  //{
  //  @Override
