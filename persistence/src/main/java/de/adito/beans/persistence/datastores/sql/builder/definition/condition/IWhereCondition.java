...
public interface IWhereCondition<TYPE> extends IColumnValueTuple<TYPE>, IConditionFormatter, INegatable<IWhereCondition<TYPE>>
{
   ...
   *
   * @param pColumn the column the condition should be based on
   * @param pValue  the value for the condition
   * @return the where condition
   */
  static <TYPE> IWhereCondition<TYPE> isEqual(IColumnDefinition<TYPE> pColumn, TYPE pValue)
  {
   ...
   * @return the where condition
   */
  static <TYPE> IWhereCondition<TYPE> isNotEqual(IColumnDefinition<TYPE> pColumn, TYPE pValue)
  {
   ...
   * @return the where condition
   */
  static <TYPE> IWhereCondition<TYPE> greaterThan(IColumnDefinition<TYPE> pColumn, TYPE pValue)
  {
   ...
   * @return the where condition
   */
  static <TYPE> IWhereCondition<TYPE> lessThan(IColumnDefinition<TYPE> pColumn, TYPE pValue)
  {
   ...
   * @return the where condition
   */
  static <TYPE> IWhereCondition<TYPE> lessThanOrEqual(IColumnDefinition<TYPE> pColumn, TYPE pValue)
  {
   ...
   * @return the where condition
   */
  static <TYPE> IWhereCondition<TYPE> between(IColumnDefinition<TYPE> pColumn, TYPE pValue)
  {
   ...
   * @return the where condition
   */
  static <TYPE> IWhereCondition<TYPE> like(IColumnDefinition<TYPE> pColumn, TYPE pValue)
  {
   ...
   *
   * @param pColumn the column definition
   * @param pValue  the value for the column
   * @param <TYPE>  the data type of the value
   * @return the where condition
   */
  static <TYPE> IWhereCondition<TYPE> of(IColumnDefinition<TYPE> pColumn, TYPE pValue)
  {
   ...
   * @return the where condition
   */
  static <TYPE> IWhereCondition<TYPE> of(IColumnDefinition<TYPE> pColumn, TYPE pValue, IWhereOperator<TYPE> pOperator)
  {
  ...
  static <SOURCE> IWhereConditions ofMultiple(Collection<SOURCE> pSourceCollection,
                                              Function<SOURCE, IColumnDefinition> pColumnResolver,
  ...
  static <SOURCE> IWhereConditions ofMultiple(Collection<SOURCE> pCollection,
                                              Function<SOURCE, IColumnDefinition> pColumnResolver,
                                              Function<SOURCE, ?> pValueResolver,
                                              BiFunction<IColumnDefinition, Object, IWhereCondition> pConditionResolver)
  {
   ...
   */
  static <TYPE> IWhereCondition<TYPE> in(IColumnDefinition<TYPE> pColumn, Iterable<TYPE> pValues)
  {
   ...
   * @return the created where condition
   */
  static <TYPE> IWhereCondition<TYPE> in(IColumnDefinition<TYPE> pColumn,
                                         BiFunction<IColumnDefinition<TYPE>, TYPE, IColumnValueTuple<TYPE>> pTupleCreator, Iterable<TYPE> pValues)
  {
   ...
   */
  static <TYPE> IWhereCondition<TYPE> in(IColumnDefinition<TYPE> pColumn,
                                         BiFunction<IColumnDefinition<TYPE>, TYPE, IColumnValueTuple<TYPE>> pTupleCreator, Stream<TYPE> pValues)
  {
